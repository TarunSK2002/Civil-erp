...
const workspacePath = 'd:\\My_Work\\Freelance\\Jeeva Construction\\jeeva-electron';
...
console.log('Searching for any .sqlite or .db file in workspace...');
const matches = findSqliteFiles(workspacePath);
