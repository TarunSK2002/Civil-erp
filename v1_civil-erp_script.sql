...
CREATE TABLE `clients` (
  ...
  `PaymentType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `labours` (
  ...
  `AccountNo` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `LabourType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `CreatedAt` datetime(6) NOT NULL,
...
CREATE TABLE `site_materials` (
  ...
  CONSTRAINT `FK_site_materials_materials_MaterialId` FOREIGN KEY (`MaterialId`) REFERENCES `materials` (`Id`) ON DELETE RESTRICT,
  CONSTRAINT `FK_site_materials_sites_SiteId` FOREIGN KEY (`SiteId`) REFERENCES `sites` (`Id`) ON DELETE CASCADE
...
CREATE TABLE `sites` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `SiteName` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  CONSTRAINT `FK_sites_clients_ClientId` FOREIGN KEY (`ClientId`) REFERENCES `clients` (`Id`) ON DELETE RESTRICT
...
) ENGINE=InnoDB AUTO_INCREMENT=3518 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-14  9:58:22
